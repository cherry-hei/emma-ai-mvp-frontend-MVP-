...
import NaacDataPanel from '@/components/reports/NaacDataPanel'
    ...
    <div className="p-5 space-y-5">
      ...
      {tab === 'scheduled' && (
        ...
        <div className="space-y-4">
          ...
          {schedules.filter((s) => !s.name_en?.includes("SQS") && !s.name_en?.includes("Annual Licence") && !s.name_en?.includes("Annual License")).map((s) => (
